                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="text-lg text-gray-600 space-y-6 leading-relaxed">
                            <p>
                                Mittal Online Services has been a Tally 3-Star Sales & Implementation Certified Partner since 13 September 2017.
                            </p>
                            <p>
                                Our company takes pride in delivering outstanding Tally sales, services, solutions, education, and customization.
                            </p>
                            <p>
                                Our skilled team includes Chartered Accountants and specialists in Income Tax and GST, committed to providing exceptional service and ensuring customer satisfaction. Our consistent performance has earned us the Best Service in Customer Management and Highest Sales Awards in the North Zone (UP West Region) across multiple quarters.
                            </p>
                        </div>
                    </div>
