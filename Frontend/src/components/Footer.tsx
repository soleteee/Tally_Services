                ...
                <ScrollReveal animation="fade-up" delay={0}>
                    <div className="mb-8 min-w-[200px]">
                        ...
                        <div className="flex gap-4 mt-6">
                            {/* Social Links */}
                            <a href="https://www.facebook.com/share/17u7msqbMH/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-[#1877F2] transition-colors group">
                            ...
                            <a href="https://www.instagram.com/mittalonlineservices?igsh=eXltYXJpbWwwbWd4" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-[#E4405F] transition-colors group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-white" viewBox="0 0 16 16">
                            ...
                            <a href="https://www.youtube.com/@mittalonlineservices3412" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-[#FF0000] transition-colors group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-white" viewBox="0 0 16 16">
                            ...
                            <a href="https://www.linkedin.com/company/mittal-online-services/about/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-[#0077B5] transition-colors group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-white" viewBox="0 0 16 16">
