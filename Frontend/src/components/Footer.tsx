                ...
                <ScrollReveal animation="fade-up" delay={0}>
                    <div className="mb-8 min-w-[200px]">
                        ...
                        <div className="flex gap-4 mt-6">
                            ...
                            <a href="https://www.youtube.com/@mittalonlineservice" target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-gray-700 rounded-full hover:bg-[#FF0000] transition-colors group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-white" viewBox="0 0 16 16">
